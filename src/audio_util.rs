pub fn convert_f_to_i32(in_buf: &[u8], out_buf: &mut [i32]) {
    let mut _buf = [0_u8; 4];
...
pub fn convert_f_to_i16(in_buf: &[u8], out_buf: &mut [i16]) {
    let mut _buf = [0_u8; 4];
    //assert_eq!(out_buf.len(), in_buf.len());
    for i in 0..in_buf.len()/4 {
        _buf.copy_from_slice(&in_buf[4*i..4*i+4]);
...
pub fn convert_i32_to_f(in_buf: &[u8], out_buf: &mut [f32]) {
    let mut _buf = [0_u8; 4];
    //assert_eq!(out_buf.len(), in_buf.len());
...
pub fn convert_i32_to_i16(in_buf: &[u8], out_buf: &mut [i16]) {
    let mut _buf = [0_u8; 4];
    //assert_eq!(out_buf.len(), in_buf.len());
    for i in 0..in_buf.len()/4 {
        _buf.copy_from_slice(&in_buf[4*i..4*i+4]);
...
pub fn convert_i16_to_f(in_buf: &[u8], out_buf: &mut [f32]) {
    let mut _buf = [0_u8; 2];
    //assert_eq!(out_buf.len(), in_buf.len());
...
pub fn convert_i16_to_i32(in_buf: &[u8], out_buf: &mut [i32]) {
    let mut _buf = [0_u8; 2];
    //assert_eq!(out_buf.len(), in_buf.len());
    let itr = (0..in_buf.len()/2).rev();
    for i in itr {
...
pub fn convert_i8_f(in_buf: &[u8], out_buf: &mut [f32]) {
    //assert_eq!(out_buf.len(), in_buf.len());
...
pub fn convert_i8_to_i32(in_buf: &[u8], out_buf: &mut [i32]) {
    //assert_eq!(out_buf.len(), in_buf.len());
    let itr = (0..in_buf.len()).rev();
    for i in itr {
...
pub fn convert_f_to_f(in_buf: &[u8], out_buf: &mut [f32]) {
    let mut _buf = [0_u8; 4];
    for i in 0..in_buf.len()/4 {
        _buf.copy_from_slice(&in_buf[4*i..4*i+4]);
        let f32_buf = f32::from_be_bytes(_buf);
