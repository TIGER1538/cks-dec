...
pub type soundtouch_SAMPLETYPE = ::std::os::raw::c_short;
#[repr(C)]
...
extern "C" {
    #[link_name = "\u{1}__ZN10soundtouch10SoundTouch10putSamplesEPKsj"]
...
extern "C" {
    #[link_name = "\u{1}__ZN10soundtouch10SoundTouch14receiveSamplesEPsj"]
